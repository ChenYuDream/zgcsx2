<!-- 课表信息查询弹出框 -->
<div id="testName" class="detailTable dialog-kcxq" ms-controller="timetableDetailInfo" class="ms-controller">
    <table>
        <tbody>
        <tr>
...
<script type="text/javascript">
    var vmTimetableDetailInfo = avalon.define({
        $id:"timetableDetailInfo",
        data:{}
    });
    vmTimetableDetailInfo.data = vmTimetableDetail.$model.showData;
</script>
